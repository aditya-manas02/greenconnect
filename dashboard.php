...
");
$stmt->execute([$_SESSION['user_id']]);
$organized_events = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body class="bg-white text-gray-800 font-sans">
  ...
  <header class="bg-white shadow-md sticky top-0 z-50">
      ...
      <div class="flex justify-between items-center">
        ...
        <div id="mobile-menu" class="hidden sm:flex flex-col sm:flex-row items-center justify-between w-full sm:w-auto order-4 sm:order-2 mt-4 sm:mt-0 absolute sm:relative top-20 sm:top-0 left-0 sm:left-auto bg-white sm:bg-transparent w-full sm:w-auto px-4 sm:px-0 pb-4 sm:pb-0 shadow-lg sm:shadow-none">
          <nav class="flex flex-col sm:flex-row items-center space-y-3 sm:space-y-0 sm:space-x-8 text-sm font-medium w-full sm:w-auto">
            ...
            <a href="dashboard.php" class="text-green-700 border-b-2 border-green-700 pb-1 w-full sm:w-auto text-center">Dashboard</a>
    ...
    <main class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <section class="mb-12">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Events You've Joined</h2>
            <?php if (empty($joined_events)): ?>
                <div class="bg-white rounded-lg shadow-md p-6 text-center text-gray-600">
                    <p>You haven't joined any events yet.</p>
                    <a href="events.php" class="text-green-700 hover:text-green-800 font-medium inline-block mt-2">
                            ...
                            <a href="event-detail.php?id=<?php echo $event['id']; ?>" class="block">
                                ...
                                <div class="p-6">
                                    ...
                                    <p class="text-sm text-green-700 font-medium">
                                        ...
                                        Joined on <?php echo date('F j, Y', strtotime($event['joined_at'])); ?>
                                    </p>
                                </div>
                            </a>
                        </div>
        ...
        <section>
            <h2 class="text-2xl font-bold text-gray-900 mb-6">Events You're Organizing</h2>
            <?php if (empty($organized_events)): ?>
                <div class="bg-white rounded-lg shadow-md p-6 text-center text-gray-600">
                    <p>You haven't organized any events yet.</p>
                    <a href="propose-event.php" class="text-green-700 hover:text-green-800 font-medium inline-block mt-2">
                        Propose a new event
                    </a>
                </div>
            <?php else: ?>
